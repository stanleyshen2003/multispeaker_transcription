...
class Voice_process_agent():
    ...
    def language_model(self):
        ...
        # same = False
        #
        same = self.text_tmp[1] == self.output_record[1]
        print(self.text_tmp[1], self.output_record[1])
        if same:
            self.output_record = [self.text_tmp[0] + " " + self.output_record[0], self.text_tmp[1]]
            ...
            self.output_record = [result[0][3:], tmp]
